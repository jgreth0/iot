...
void iot() {
    ...
    kasa_alarm morning_light_tree_xmas     = kasa_alarm(&light_tree_xmas    , "morning_light_tree_xmas    ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_tree_xmas);
    kasa_alarm morning_light_front_porch   = kasa_alarm(&light_front_porch  , "morning_light_front_porch  ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_front_porch);
    kasa_alarm morning_light_front_garage  = kasa_alarm(&light_front_garage , "morning_light_front_garage ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_front_garage);
    kasa_alarm morning_light_rear_garage   = kasa_alarm(&light_rear_garage  , "morning_light_rear_garage  ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_rear_garage);
    kasa_alarm morning_light_rear_deck     = kasa_alarm(&light_rear_deck    , "morning_light_rear_deck    ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_rear_deck);
    kasa_alarm morning_light_rear_flood    = kasa_alarm(&light_rear_flood   , "morning_light_rear_flood   ", kasa::OFF, 7, 0);
    am.add_automation(&morning_light_rear_flood);
    kasa_alarm morning_light_rear_basement = kasa_alarm(&light_rear_basement, "morning_light_rear_basement", kasa::OFF, 7, 0);
